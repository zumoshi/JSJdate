var JDate={
	now:function(){return JDate.out(JDate.tarikh(new Date()/1000));},
	rooz:function(){return JDate.tarikh(new Date()/1000)[2];},
	mah:function(){return JDate.tarikh(new Date()/1000)[1];},
	sal:function(){return JDate.tarikh(new Date()/1000)[0];},
	tabdil:function(d){return JDate.out(JDate.tarikh(JDate.inp(d)));},
	out:function(a){return {rooz:a[2],mah:a[1],sal:a[0],day:a[2],month:a[1],year:a[0],toString:JDate.toString}},
	inp:function(i){return new Date(i).getTime()/1000},
	toString:function(d){
		if(typeof this.rooz !=="undefined" && typeof this.rooz !=="function"){return this.sal+'/'+this.mah+'/'+this.rooz}
		else if(typeof d==="undefined"){return JDate.sal()+'/'+JDate.mah()+'/'+JDate.rooz()}
		else if(typeof d.rooz!="undefined"){return d.sal+'/'+d.mah+'/'+d.rooz}
		else return 'err'
	},
	tarikh: function(u_t){
